...
<ul id="league-nav" class="nav nav-pills">
    ...
    <li class="active"><a href="<%=request.getContextPath()%>/grandmaster"><img src="<%=request.getContextPath()%>/images/grade7.png">宗师</a></li>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        buildTable("GRANDMASTER",1,PAGESIZE);//默认空白查全部
    });
</script>
</body>
</html>